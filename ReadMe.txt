Quantum-Minesweeper – it’s a game, where you need to open all cells of the field and don’t blow on the mine. But mines change their position with some period. 
...
Future improvements: make that some opened cells become undiscovered with time and speed of undiscovering is growing with time. It has to makes the game more interesting.
